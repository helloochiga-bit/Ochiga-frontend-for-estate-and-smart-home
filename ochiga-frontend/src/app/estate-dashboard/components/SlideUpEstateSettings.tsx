// ochiga-frontend/src/app/estate-dashboard/components/SlideUpEstateSettings.tsx
"use client";

import { useEffect } from "react";
import { FaUserCircle, FaBell, FaPlug, FaShieldAlt, FaTools, FaSignOutAlt } from "react-icons/fa";
import { FiX } from "react-icons/fi";
import { SettingsSection, SettingsItem } from "../../components/SettingsComponents"; // adjust path if needed

type SlideUpEstateSettingsProps = {
  isOpen: boolean;
  onClose: () => void;
};

export default function SlideUpEstateSettings({ isOpen, onClose }: SlideUpEstateSettingsProps) {
  const sections = [
    {
      title: "Account",
      items: [
        { title: "Email", subtitle: "estateadmin@example.com" },
        { title: "Subscription", value: "Premium Plan" },
        { title: "Upgrade Plan" },
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Devices & Connectors", icon: FaPlug },
      ...
      >
        <div className="bg-gray-900 rounded-t-3xl max-h-[90vh] overflow-y-auto shadow-xl">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-700">
            <h2 className="text-lg font-semibold text-white">Estate Settings</h2>
            <button
              onClick={onClose}
